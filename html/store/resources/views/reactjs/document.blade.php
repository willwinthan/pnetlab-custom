...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="{{ \App\Helpers\Control\Ctrl::get('ctrl_logo', '/store/public/assets/auth/img/logo.png') }}">
        
        <style>
            :root {
                --primary-color: {{ \App\Helpers\Control\Ctrl::get('ctrl_primary_color', '#0d274d') }};
                --secondary-color: {{ \App\Helpers\Control\Ctrl::get('ctrl_secondary_color', '#1b4079') }};
                --bg-color: {{ \App\Helpers\Control\Ctrl::get('ctrl_bg_color', '#0d274d') }};
            }
        </style>
