    ...
    render() {
		return (<>
            ...
            <div className='box_flex box_padding' style={{position:'relative', borderBottom: 'dashed thin white', color:'white'}}>
                <img src={App.server.common['APP_LOGO'] || "/store/public/assets/auth/img/logo.png"} style={{height: 40, margin: 'auto 20px auto 40px'}}/> 
            ...
            <div style={{height:'90%', justifyContent:'center', position:'relative'}} className='box_flex'>
                <div style={{width:550}}>
                    ...
                    <div style={{marginBottom:50, textAlign: 'center'}}>
                        <img src={App.server.common['APP_LOGO'] || "/store/public/assets/auth/img/logo.png"} style={{height: 150}}/> 
